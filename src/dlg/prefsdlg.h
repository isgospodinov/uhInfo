...
private:
   ...
   Gtk::CheckButton ch_InTmpMon,ch_AllInput,ch_SaveImp,ch_NativeFq,ch_ShowCPUfq,ch_lscpu_cpuinfo,ch_Marck_Stress_Session;
   Gtk::Label l_MaxTemp;
   Gtk::Box box_all,box_MaxTmp,box_InTmpMon,box_AllInput,box_SaveImp,box_NativeFq,box_ShowCPUfq,box_cpu_lsorinfo,box_Marck_Stress_Session;
   Gtk::Frame fr_All;
